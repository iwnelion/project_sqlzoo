...
-- 2.
-- Checking a list The word IN allows us to check if an item is in a list. The example shows
...
-- of 250,000-300,000 sq. km. Modify it to show the country and the area for countries with an 
