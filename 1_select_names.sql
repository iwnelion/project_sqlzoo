...
-- 8.
-- India and Angola have an n as the second character. You can use the underscore as a single 
-- character wildcard.
...
-- Show the name and the extension where the capital is a proper (non-empty) extension of name 
-- of the country.
SELECT name AS country, REPLACE(capital, name, '') AS extension FROM world 
