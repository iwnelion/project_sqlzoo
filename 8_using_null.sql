...
-- 5. Use COALESCE to print the mobile number. Use the number '07986 444 2266' if there is
...
then 'Sci' else 'Art' end as dept
 from teacher

-- 10. Use CASE to show the name of each teacher followed by 'Sci' if the teacher is in dept 1
